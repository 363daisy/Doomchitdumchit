...
//                    NavigationLink(destination: AlbumDetailView(album: albumMatchingDetectedBarcode, firstNaviLinkActive: $firstNaviLinkActive), isActive: $isDetectedAlbumDetailViewActive) {
//                        EmptyView()
//                    }
//                }
            }
...
struct ContentView_Previews: PreviewProvider {
    static var previews: some View {
        MusicSearchView(returnNaviLinkActive: .constant(true))
    }
}
